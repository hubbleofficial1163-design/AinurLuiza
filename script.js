...
// ========== GOOGLE SHEETS ==========
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwUiNeEIrbH-kpPiDXkDq1hKGZpGqarLVz1Sd1-RzOpXV8OkaeHcHqhsOOUE470HtAjtQ/exec'; // ЗАМЕНИТЕ НА ВАШ URL
    ...
    rsvpForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (result.result === 'success') {
                ...
                if (attendance === 'yes') {
                    attendanceMessage = 'Мы будем ждать вас на нашей свадьбе 18 июля 2026 года! 🎉';
